...
* **Textual/**: Text-based experiments, split by data augmentation/generation method (qualitative vs. non-qualitative)
* **Image/**: Visual experiments using local VLLMs, Stable Diffusion models and a GAN
